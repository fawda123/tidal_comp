...
# 
# # process
# wrtds_val1 <- foreach(val = 1:nrow(grd)) %dopar% {   
#   
#   library(dplyr)
#   library(WRTDStidal)
#   
...
#     flolab = expression(paste('ln-Flow (', m^3, ' ', s^-1, ')'))
#     ) %>% 
#     wrtds(wins = as.list(wk_opt$par), min_obs = pmin(nrow(mod), 100)))
#   
...
# }
# 
# save(wrtds_val1, file = 'data/wrtds_val1.RData', compress = 'xz')
#   
# ######
...
# 
# # process
# gams_val1 <- foreach(val = 1:nrow(grd)) %dopar% {   
#   
#   library(dplyr)
#   library(WRTDStidal)
#   library(mgcv)
...
# }
# 
# save(gams_val1, file = 'data/gams_val1.RData', compress = 'xz')
# 
# ######
# # get WRTDS validation error 2
# 
# # window widths data
# data(wk_opt)
# 
...
# 
# # process
# wrtds_val2 <- foreach(val = 1:nrow(grd)) %dopar% {   
#   
#   library(dplyr)
#   library(WRTDStidal)
#   
...
# }
# 
# save(wrtds_val2, file = 'data/wrtds_val2.RData', compress = 'xz')
